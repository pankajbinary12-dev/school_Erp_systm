...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="mb-0"><i class="fas fa-plus-circle"></i> New Enquiry</h4>
       ...
       <div class="col-md-4 mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="session_id" class="form-select @error('session_id') is-invalid @enderror" required>
                        ...
                        <option value="{{ $session->session_name }}" {{ old('session_id') == $session->id ? 'selected' : '' }}>{{ $session->session_name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="previous_school" class="form-control @error('previous_school') is-invalid @enderror" value="{{ old('previous_school') }}">
                    @error('previous_school')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label">Previous Class</label>
                    <input type="text" name="previous_class" class="form-control @error('previous_class') is-invalid @enderror" value="{{ old('previous_class') }}">
                    @error('previous_class')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label">Previous Percentage</label>
                    <input type="number" step="0.01" name="previous_percentage" class="form-control @error('previous_percentage') is-invalid @enderror" value="{{ old('previous_percentage') }}">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <input type="number" step="0.01" name="annual_income" class="form-control @error('annual_income') is-invalid @enderror" value="{{ old('annual_income') }}">
                    @error('annual_income')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                  <div class="col-md-4">
                    <label class="form-label">guardian_phone</label>
                    <input type="text" name="guardian_phone" class="form-control @error('guardian_phone') is-invalid @enderror" value="{{ old('mother_occupation') }}">
                    @error('mother_occupation')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="reference_by" class="form-control @error('reference_by') is-invalid @enderror" value="{{ old('reference_by') }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="registration_fee" class="form-control @error('registration_fee') is-invalid @enderror" value="{{ old('registration_fee', 500) }}" required>
